					...
					<div class="market-overview-main">
						<div class="market-overview-wrap">
							<div class="market-overview-top">
								...
								<div class="w-layout-vflex market-overview-top-wrap gap12">
									<div class="inter _25s bold">
										<spring:message code="ethereumEtf.title" />
										<br>
									</div>
								</div>
								<div class="inter _14s normal _61co">
									<spring:message code="ethereumEtf.description" />
									<br>
								</div>
							</div>
							<div class="market-overview-middle">
								<div class="market-overview-info">
									<div class="m-o-info-area width350">
										<div class="m-o-card gap24 h-auto">
											<div class="card-header">
												<div class="card-header-title">
													<strong><spring:message code="ethereumEtf.netInflow" /></strong> <span class="small-61co"><strong><spring:message code="ethereumEtf.date.feb2025" /></strong></span>
												</div>
											</div>
										...
										<div class="m-o-card gap24 h-auto">
											<div class="card-header">
												<div class="card-header-title">
													<spring:message code="ethereumEtf.pastFigures" />
												</div>
											</div>
											<div class="m-o-txt-list">
												<div class="m-o-txt-box">
													<div class="inter _12s medium _61co">
														<spring:message code="ethereumEtf.yesterday" />
													</div>
												...
												<div class="m-o-txt-box">
													<div class="inter _12s medium _61co">
														<spring:message code="ethereumEtf.lastWeek" />
													</div>
												...
												<div class="m-o-txt-box">
													<div class="inter _12s medium _61co">
														<spring:message code="ethereumEtf.last3Months" />
													</div>
													<div class="inter _12s bold up">
														+ $215.25<br>
													</div>
										...
										<div class="m-o-coin-rate gap24 h-auto">
											<div class="card-header">
												<div class="card-header-title">
													<spring:message code="ethereumEtf.annualPerformance" />
												</div>
											</div>
											<div class="m-o-txt-list">
												<div class="m-o-txt-box">
													<div class="inter _12s medium _61co">
														<spring:message code="ethereumEtf.annualHigh" />
														(Dec 18, 2024)
													</div>
												...
												<div class="m-o-txt-box">
													<div class="inter _12s medium _61co">
														<spring:message code="ethereumEtf.annualLow" />
														(Aug 05, 2024)
													</div>
													<div class="inter _12s bold down">
														$197.34<br>
									...
									<div class="m-o-chart-box">
										<div class="card-header between space">
											<div class="card-header-title">
												<strong><spring:message code="ethereumEtf.inflowChart" /></strong>
											</div>
											<div class="m-o-chart-btn-box">
												<div class="m-o-chart-btn-wrap">
													<a href="#" class="tabselect-chart-btn on w-button"><spring:message code="ethereumEtf.totalInflow" /></a> <a href="#" class="tabselect-chart-btn w-button"><spring:message code="ethereumEtf.byFund" /></a>
												</div>
												<div class="m-o-chart-btn-wrap">
													<a href="#" class="tabselect-chart-btn on w-button"><spring:message code="ethereumEtf.time30d" /></a> <a href="#" class="tabselect-chart-btn w-button"><spring:message code="ethereumEtf.time1y" /></a> <a href="#" class="tabselect-chart-btn w-button"><spring:message code="ethereumEtf.timeAll" /></a>
												</div>
										...
										<div class="m-o-chart-txt-box">
											<div class="txt-flex-box">
												<div class="chart-wrap-box">
													...
													<div class="inter _12s medium _61co">
														<spring:message code="ethereumEtf.totalInflow" />
														<br>
													</div>
												</div>
											</div>
											<div class="txt-flex-box">
												<div class="chart-wrap-box">
													...
													<div class="inter _12s medium _61co">
														<spring:message code="ethereumEtf.ethereumPrice" />
														<br>
													</div>
												</div>
											</div>
								...
								<div class="market-overview-chart-box">
									<div class="m-o-chart-box">
										<div class="card-header between space">
											<div class="card-header-title">
												<spring:message code="ethereumEtf.totalAum" />
												<br>
											</div>
											<div class="m-o-chart-btn-box">
												<div class="m-o-chart-btn-wrap">
									...
									<div class="m-o-chart-box">
										<div class="card-header between space">
											<div class="card-header">
												<div class="card-header-title">
													<spring:message code="ethereumEtf.aumPercentage" />
													<br>
												</div>
								...
								<div class="market-overview-etf-table">
									<div class="w-layout-vflex left-flex-box">
										<div class="m-o-chart-btn-wrap">
											<a href="#" class="tabselect-chart-btn on w-button"> <spring:message code="ethereumEtf.tab.overview" />
											</a> <a href="#" class="tabselect-chart-btn w-button"> <spring:message code="ethereumEtf.tab.flow" />
											</a>
										</div>
										<div class="m-o-chart-btn-wrap">
							...
							<div class="market-overview-bottom">
								<div class="inter _25s bold">
									<spring:message code="ethereumEtf.newsTitle" />
								</div>
							...
							<div class="market-overview-faq-txt">
								<div class="w-layout-vflex market-overview-top-wrap between">
									<div class="inter _25s bold">
										<spring:message code="ethereumEtf.faqTitle" />
										<br>
									</div>
								</div>
									...
									<div class="faq-list">
										<div class="w-layout-vflex index-list-title">
											<div class="inter _16s medium">
												<strong><spring:message code="ethereumEtf.faq01.q" /></strong>
											</div>
											<div class="fqa-arrow light"></div>
										</div>
										<div class="w-layout-vflex faq-detail">
											<div class="inter _14s normal _61co">
												<spring:message code="ethereumEtf.faq01.a" />
											</div>
										</div>
									</div>
									<div class="faq-list">
										<div class="w-layout-vflex index-list-title">
											<div class="inter _16s medium">
												<strong><spring:message code="ethereumEtf.faq02.q" /></strong>
											</div>
											<div class="fqa-arrow light"></div>
										</div>
										<div class="w-layout-vflex faq-detail">
											<div class="inter _14s normal _61co">
												<spring:message code="ethereumEtf.faq02.a" />
											</div>
										</div>
									</div>
									<div class="faq-list">
										<div class="w-layout-vflex index-list-title">
											<div class="inter _16s medium">
												<strong><spring:message code="ethereumEtf.faq03.q" /></strong>
											</div>
											<div class="fqa-arrow light"></div>
										</div>
										<div class="w-layout-vflex faq-detail">
											<div class="inter _14s normal _61co">
												<spring:message code="ethereumEtf.faq03.a" />
											</div>
										</div>
									</div>
									<div class="faq-list">
										<div class="w-layout-vflex index-list-title">
											<div class="inter _16s medium">
												<strong><spring:message code="ethereumEtf.faq04.q" /></strong>
											</div>
											<div class="fqa-arrow light"></div>
										</div>
										<div class="w-layout-vflex faq-detail">
											<div class="inter _14s normal _61co">
												<spring:message code="ethereumEtf.faq04.a" />
											</div>
										</div>
									</div>
									<div class="faq-list">
										<div class="w-layout-vflex index-list-title">
											<div class="inter _16s medium">
												<strong><spring:message code="ethereumEtf.faq05.q" /></strong>
											</div>
											<div class="fqa-arrow light"></div>
										</div>
										<div class="w-layout-vflex faq-detail">
											<div class="inter _14s normal _61co">
												<spring:message code="ethereumEtf.faq05.a" />
											</div>
										</div>
									</div>
									<div class="faq-list">
										<div class="w-layout-vflex index-list-title">
											<div class="inter _16s medium">
												<strong><spring:message code="ethereumEtf.faq06.q" /></strong>
											</div>
											<div class="fqa-arrow light"></div>
										</div>
										<div class="w-layout-vflex faq-detail">
											<div class="inter _14s normal _61co">
												<spring:message code="ethereumEtf.faq06.a" />
											</div>
										</div>
									</div>
								</div>
				...
				<div class="frame">
					<div class="stay-wrap">
						<div class="inter _32s bold">
							<strong><spring:message code="ethereumEtf.stayTitle" /></strong>
						</div>
						<div class="stay-sub-tt">
							<spring:message code="ethereumEtf.stayDescription" />
						</div>
						<div class="form-block w-form">
							<form id="email-form" name="email-form" data-name="Email Form" method="get" class="form" data-wf-page-id="67b830e496b78efd5097c6f7" data-wf-element-id="638f6fd3-9be0-81dd-7399-3bc28d221dac">
								<input class="text-field w-input" maxlength="256" name="name-2" data-name="Name 2" placeholder="<spring:message code='ethereumEtf.emailPlaceholder' />" type="text" id="name-2">
								<input type="submit" data-wait="<spring:message code='ethereumEtf.submitWait' />" class="submit-button w-button" value="<spring:message code='ethereumEtf.submit' />">
							</form>
						</div>
					</div>
				</div>
