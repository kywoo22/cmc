			...
			<div class="body-wrap">
				<div class="frame no-max">
						...
						<div class="coin-list">
							<c:forEach var="item" items="${topList }">
								<div class="list">
									...
									<div class="w-layout-vflex coin-table-top-wrap width200per right">
										<div class="coin-txt-table rate-icon ${item.changeDirection }">${item.change }</div>
									</div>
									<div class="w-layout-vflex coin-table-top-wrap width200per right">
										<div class="coin-txt-table price semibold">${item.volume }</div>
									</div>
								</div>
							</c:forEach>
						</div>
					...
					<div class="coin-table">
						...
						<div class="coin-list">
							<c:forEach var="item" items="${lowList }">
								<div class="list">
									<div class="w-layout-vflex coin-table-top-wrap num">
										<div class="coin-txt-table">${item.rank}</div>
									</div>
