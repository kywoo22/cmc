					...
					<div class="widget-header">
						<div class="widget-header-content">
							<div class="widget-title">
								<spring:message code="price-marquee.title" />
							</div>
							<div class="inter _14s normal _61co">
								<spring:message code="price-marquee.description" />
							</div>
						</div>
					</div>
					<div class="widget-main">
						<div class="widget-side-tap">
							<div class="inter _12s medium _61co">
								<spring:message code="price-marquee.selectWidget" />
							...
							<div class="widget-link-list">
								<a href="/cmc/service/ticker.do" aria-current="page" class="widget-link w-inline-block w--current">
									<div>
										<spring:message code="price-marquee.widget.ticker" />
									</div>
								</a> <a href="/cmc/service/price-marquee.do" class="widget-link on w-inline-block">
									<div>
										<spring:message code="price-marquee.widget.marquee" />
									</div>
								</a> <a href="/cmc/service/price-blocks.do" class="widget-link w-inline-block">
									<div>
										<spring:message code="price-marquee.widget.blocks" />
									</div>
								</a>
							</div>
						</div>
							...
							<div class="contents-wrapper">
									...
									<div class="widget-drop-list">
										<div class="w-layout-vflex widget-drop-wrap">
											<div class="inter _14s normal">
												<spring:message code="price-marquee.label.currency" />
												<br>
											</div>
											<div class="widget-drop-box">
												<div class="w-layout-vflex drop-head">
													<div class="w-layout-vflex drop-left">
														...
														<div class="inter _14s normal _61co">
															<spring:message code="price-marquee.label.searchCurrency" />
															<br>
														</div>
													</div>
												</div>
										...
										<div class="w-layout-vflex widget-drop-wrap">
											<div class="inter _14s normal">
												<spring:message code="price-marquee.label.fiatCurrency" />
												<br>
											</div>
											<div class="widget-drop-box">
												<div class="w-layout-vflex drop-head">
										...
										<div class="w-layout-vflex widget-drop-wrap">
											<div class="inter _14s normal">
												<spring:message code="price-marquee.label.secondaryCurrency" />
												<br>
											</div>
											<div class="widget-drop-box">
												<div class="w-layout-vflex drop-head">
										...
										<div class="w-layout-vflex widget-drop-wrap">
											<div class="inter _14s normal">
												<spring:message code="price-marquee.label.theme" />
												<br>
											</div>
											<div class="widget-drop-box">
												<div class="w-layout-vflex drop-head">
													<div class="w-layout-vflex drop-left">
														<div class="inter _14s bold">
															<spring:message code="price-marquee.theme.light" />
															<br>
														</div>
													</div>
													<img src="/cmc/webflow/images/arrow_drop_black.svg" loading="lazy" alt="">
											...
											<div class="setting-form-block w-form">
												<form id="email-form" name="email-form" data-name="Email Form" method="get" class="setting-form" data-wf-page-id="67d134c302781f23be7ca757" data-wf-element-id="f7f7a5f3-8ff5-ca29-a0c0-78ef78c9bd30">
													<div class="w-layout-vflex setting-list">
														<div class="inter _14s bold">
															<strong><spring:message code="price-marquee.setting.transparentBackground" /></strong><br>
														</div>
													...
													<div class="w-layout-vflex setting-list">
														<div class="inter _14s bold">
															<strong><spring:message code="price-marquee.setting.showIcon" /></strong><br>
														</div>
								...
								<div class="half gap24 padding-c">
									<div class="widget-show">
										<div class="inter _12s medium _61co">
											<spring:message code="price-marquee.preview" />
											<br>
										</div>
									</div>
									<div class="w-layout-vflex website-widget">
										<div class="inter _14s normal">
											<spring:message code="price-marquee.websiteWidget" />
											<br>
										</div>
										...
										<div class="inter _12s normal _61co">
											<spring:message code="price-marquee.copyInstruction" />
										</div>
									</div>
								</div>
							</div>
