...
<html data-wf-page="67e101890a74e90f9a9c9c6b" data-wf-site="67ac1e9d774ae9ae33d5f462">
<head>
<meta charset="utf-8">
<title>ai-big-data</title>
				...
				<div class="frame no-max">
					<div class="main-txt-box">
						...
						<div class="main-txt-flex">
							<div>
								<spring:message code="ai-big-data.description" />
								<br>
							</div>
						</div>
					</div>
					<div class="cardlist-box">
							...
							<div class="highlight-top">
								<a href="#" class="highlight-left w-inline-block">
									<div class="card-header-info-title">
										<spring:message code="ai-big-data.mostViewed" />
										<br>
									</div>
								</a>
								<div class="h-tap">
						...
						<div class="highlights-coin-card cardlist">
							<div class="highlight-top">
								<a href="#" class="highlight-left w-inline-block">
									<div class="card-header-info-title">
										<spring:message code="ai-big-data.topGainers" />
										<br>
									</div>
								</a>
								<div class="h-tap">
									<a href="#" class="tabselect-h empty on w-button"> <spring:message code="ai-big-data.time24h" />
									</a> <a href="#" class="tabselect-h empty w-button"> <spring:message code="ai-big-data.time30d" />
									</a> <a href="#" class="tabselect-h empty w-button"> <spring:message code="ai-big-data.allTime" />
									</a>
								</div>
							</div>
						...
						<div class="highlights-coin-card cardlist">
							<div class="highlight-top">
								<a href="#" class="highlight-left w-inline-block">
									<div class="card-header-info-title">
										<spring:message code="ai-big-data.marketCap" />
										<br>
									</div>
								</a>
						...
						<div class="coin-list">
							<c:forEach var="item" items="${list}">
								<div class="list">
									...
									<div class="w-layout-vflex coin-table-top-wrap width180 graph" style="background-image:url('${item.priceChart7d}')"></div>
								</div>
							</c:forEach>
						</div>
					</div>
				...
				<div class="frame">
					<div class="stay-wrap">
						...
						<div class="stay-sub-tt">
							<spring:message code="ai-big-data.inboxUpdates" />
						</div>
						<div class="form-block w-form">
							<form id="email-form" name="email-form" data-name="Email Form" method="get" class="form" data-wf-page-id="67e101890a74e90f9a9c9c6b" data-wf-element-id="363d8694-dc8f-870c-bef0-19dbee20ae6c">
								<input class="text-field w-input" maxlength="256" name="name-2" data-name="Name 2" placeholder="<spring:message code='ai-big-data.emailPlaceholder'/>" type="text" id="name-2">
								<input type="submit" data-wait="Please wait..." class="submit-button w-button" value="<spring:message code='ai-big-data.submit'/>">
							</form>
						</div>
					</div>
				</div>
