...
<html data-wf-page="67e100ed880ca04c7c499ab3" data-wf-site="67ac1e9d774ae9ae33d5f462">
<head>
<meta charset="utf-8">
				...
				<div class="frame">
					<div class="main-txt-box">
						<div class="main-title">
							<spring:message code="made-in-america.mainTitle" />
							<br>
						</div>
						<div class="main-txt-flex">
							<div>
								<spring:message code="made-in-america.description" />
								<br>
							</div>
						</div>
					</div>
					<div class="card-info-box">
						<div class="card-info">
							<div class="card-info-flex">
								<div class="inter _12s normal _61co">
									<spring:message code="made-in-america.marketCap" />
								</div>
						...
						<div class="card-info">
							<div class="card-info-flex">
								<div class="inter _12s normal _61co">
									<spring:message code="made-in-america.volume" />
								</div>
								<div class="inter _16s semibold">
									<strong>₩183,703,400,327,467</strong>
								</div>
				...
				<div class="frame">
					<div class="stay-wrap">
						...
						<div class="stay-sub-tt">
							<spring:message code="made-in-america.inboxUpdates" />
						</div>
						<div class="form-block w-form">
							<form id="email-form" name="email-form" data-name="Email Form" method="get" class="form" data-wf-page-id="67e100ed880ca04c7c499ab3" data-wf-element-id="e21860a6-b8f6-963f-8861-5f84ee6f1e7a">
								<input class="text-field w-input" maxlength="256" name="name-2" data-name="Name 2" placeholder="<spring:message code='made-in-america.emailPlaceholder'/>" type="text" id="name-2">
								<input type="submit" data-wait="Please wait..." class="submit-button w-button" value="<spring:message code='made-in-america.submit'/>">
							</form>
						</div>
					</div>
				</div>
