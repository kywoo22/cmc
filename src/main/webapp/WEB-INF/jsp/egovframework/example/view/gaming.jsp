...
<html data-wf-page="67e102546b20be04c7da710f" data-wf-site="67ac1e9d774ae9ae33d5f462">
<head>
<meta charset="utf-8">
<title>gaming</title>
				...
				<div class="frame no-max">
					<div class="main-txt-box">
						<div class="main-title">
							<spring:message code="gaming.mainTitle" />
							<br>
						</div>
						<div class="main-txt-flex">
							<div>
								<spring:message code="gaming.description" />
								<br>
							</div>
						</div>
					</div>
					<div class="cardlist-box">
							...
							<div class="highlight-top">
								<a href="#" class="highlight-left w-inline-block">
									<div class="card-header-info-title">
										<spring:message code="gaming.mostViewed" />
										<br>
									</div>
								</a>
								<div class="h-tap">
						...
						<div class="highlights-coin-card cardlist">
							<div class="highlight-top">
								<a href="#" class="highlight-left w-inline-block">
									<div class="card-header-info-title">
										<spring:message code="gaming.topGainers" />
										<br>
									</div>
								</a>
								<div class="h-tap">
									<a href="#" class="tabselect-h empty on w-button"> <spring:message code="gaming.time24h" />
									</a> <a href="#" class="tabselect-h empty w-button"> <spring:message code="gaming.time30d" />
									</a> <a href="#" class="tabselect-h empty w-button"> <spring:message code="gaming.allTime" />
									</a>
								</div>
							</div>
						...
						<div class="highlights-coin-card cardlist">
							<div class="highlight-top">
								<a href="#" class="highlight-left w-inline-block">
									<div class="card-header-info-title">
										<spring:message code="gaming.marketCap" />
										<br>
									</div>
								</a>
				...
				<div class="frame">
					<div class="stay-wrap">
						...
						<div class="stay-sub-tt">
							<spring:message code="gaming.inboxUpdates" />
						</div>
						<div class="form-block w-form">
							<form id="email-form" name="email-form" data-name="Email Form" method="get" class="form" data-wf-page-id="67e102546b20be04c7da710f" data-wf-element-id="a715340b-1e09-ffb7-aaf8-ade0693aa86b">
								<input class="text-field w-input" maxlength="256" name="name-2" data-name="Name 2" placeholder="<spring:message code='gaming.emailPlaceholder'/>" type="text" id="name-2">
								<input type="submit" data-wait="Please wait..." class="submit-button w-button" value="<spring:message code='gaming.submit'/>">
							</form>
						</div>
					</div>
				</div>
