...
<html data-wf-page="67e102b3fdac188d1b0e4560" data-wf-site="67ac1e9d774ae9ae33d5f462">
<head>
<meta charset="utf-8">
<title>depin</title>
				...
				<div class="frame">
					<div class="main-txt-box">
						<div class="main-title">
							<spring:message code="depin.mainTitle" />
							<br>
						</div>
						<div class="main-txt-flex">
							<div>
								<spring:message code="depin.description" />
								<br>
							</div>
						</div>
					</div>
					<div class="card-info-box">
						<div class="card-info">
							<div class="card-info-flex">
								<div class="inter _12s normal _61co">
									<spring:message code="depin.marketCap" />
								</div>
						...
						<div class="card-info">
							<div class="card-info-flex">
								<div class="inter _12s normal _61co">
									<spring:message code="depin.volume" />
								</div>
								<div class="inter _16s semibold">
									<strong>₩183,703,400,327,467</strong>
								</div>
				...
				<div class="frame">
					<div class="stay-wrap">
						...
						<div class="stay-sub-tt">
							<spring:message code="depin.inboxUpdates" />
						</div>
						<div class="form-block w-form">
							<form id="email-form" name="email-form" data-name="Email Form" method="get" class="form" data-wf-page-id="67e102b3fdac188d1b0e4560" data-wf-element-id="4d6a78c4-37cd-bc23-b110-57fdf269b799">
								<input class="text-field w-input" maxlength="256" name="name-2" data-name="Name 2" placeholder="<spring:message code='depin.emailPlaceholder'/>" type="text" id="name-2">
								<input type="submit" data-wait="Please wait..." class="submit-button w-button" value="<spring:message code='depin.submit'/>">
							</form>
						</div>
					</div>
				</div>
