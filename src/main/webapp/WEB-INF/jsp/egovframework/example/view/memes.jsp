...
<html data-wf-page="67e0f814622c48633d160eb0" data-wf-site="67ac1e9d774ae9ae33d5f462">
<head>
<meta charset="utf-8">
<title>memes</title>
				...
				<div class="frame no-max">
					<div class="main-txt-box">
						...
						<div class="main-txt-flex">
							<div>
								<spring:message code="memes.description" />
								<br>
							</div>
						</div>
					</div>
							...
							<div class="highlight-top">
								<a href="#" class="highlight-left w-inline-block">
									<div class="card-header-info-title">
										<spring:message code="memes.mostViewed" />
										<br>
									</div>
								</a>
								<div class="h-tap">
					...
					<div class="table-control">
						<div class="table-btn-filter">
							<a href="#" class="table-btn empty on w-inline-block">
								...
								<div>Doggone Doggerel</div>
							</a> <a href="#" class="table-btn empty w-inline-block">
								<div>Cat-Themed</div>
							</a> <a href="#" class="table-btn empty w-inline-block">
								<div>Political Memes</div>
							</a> <a href="#" class="table-btn empty w-inline-block">
								<div>Celebrity Memes</div>
							</a> <a href="#" class="table-btn empty w-inline-block">
								<div>AI Memes</div>
							</a> <a href="#" class="table-btn empty w-inline-block">
								<div>AI Agents</div>
								...
								<div>Pump Fun Ecosystem</div>
							</a> <a href="#" class="table-btn empty w-inline-block">
								<div>Zodiac-Themed</div>
							</a> <a href="#" class="table-btn empty w-inline-block">
								<div>
									<strong>IP Memes</strong>
								</div>
							</a>
						</div>
					</div>
				...
				<div class="frame">
					<div class="stay-wrap">
						...
						<div class="stay-sub-tt">
							<spring:message code="memes.inboxUpdates" />
						</div>
						<div class="form-block w-form">
							<form id="email-form" name="email-form" data-name="Email Form" method="get" class="form" data-wf-page-id="67e0f814622c48633d160eb0" data-wf-element-id="af34aa62-944e-8dfe-db5c-298b5296d856">
								<input class="text-field w-input" maxlength="256" name="name-2" data-name="Name 2" placeholder="<spring:message code='memes.emailPlaceholder'/>" type="text" id="name-2">
								<input type="submit" data-wait="Please wait..." class="submit-button w-button" value="<spring:message code='memes.submit'/>">
							</form>
						</div>
					</div>
				</div>
