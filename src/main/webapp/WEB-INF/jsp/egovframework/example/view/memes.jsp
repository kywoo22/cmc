				...
				<div class="frame">
					<div class="main-txt-box">
						<div class="main-title">
							시가총액 기준 상위 Memes 토큰<br>
						</div>
						<div class="main-txt-flex">
							<div>
								이 페이지에는 상위 밈(meme) 코인 및 토큰이 나열되어 있습니다. 이러한 프로젝트는 시가총액 기준으로 가장 규모가 큰 것부터 내림차순으로 나열됩니다.<br>
							</div>
						</div>
					</div>
					<div class="cardlist-box">
						...
						<div class="highlights-coin-card cardlist">
							<div class="highlight-top">
								...
								<div class="h-tap">
									<a href="#" class="tabselect-h empty on w-button">24시간</a> <a href="#" class="tabselect-h empty w-button">30일</a> <a href="#" class="tabselect-h empty w-button">전체</a>
								</div>
							</div>
