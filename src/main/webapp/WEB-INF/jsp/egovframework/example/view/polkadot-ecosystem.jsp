...
<html data-wf-page="67e100ae8e81037e9e93d9f1" data-wf-site="67ac1e9d774ae9ae33d5f462">
<head>
<meta charset="utf-8">
<title>polkadot-ecosystem</title>
				...
				<div class="frame no-max">
					<div class="main-txt-box">
						<div class="main-title">
							<spring:message code="dot.mainTitle" />
							<br>
						</div>
						<div class="main-txt-flex">
							<div>
								<spring:message code="dot.description" />
								<br>
							</div>
						</div>
					</div>
				...
				<div class="frame">
					<div class="stay-wrap">
						...
						<div class="stay-sub-tt">
							<spring:message code="dot.inboxUpdates" />
						</div>
						<div class="form-block w-form">
							<form id="email-form" name="email-form" data-name="Email Form" method="get" class="form" data-wf-page-id="67e100ae8e81037e9e93d9f1" data-wf-element-id="35769017-e045-214c-1c3a-264692730168">
								<input class="text-field w-input" maxlength="256" name="name-2" data-name="Name 2" placeholder="<spring:message code='dot.emailPlaceholder'/>" type="text" id="name-2">
								<input type="submit" data-wait="Please wait..." class="submit-button w-button" value="<spring:message code='dot.submit'/>">
							</form>
						</div>
					</div>
				</div>
