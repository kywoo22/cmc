				...
				<div class="frame">
					<div class="main-txt-box">
						<div class="main-title">
							Top Rehypothecated Crypto (Wrapped, Staked, and Restaked) by Market Capitalization<br>
						</div>
						<div class="main-txt-flex">
							<div>
								Listed below are the top staked and wrapped assets by Market Capitalization.<br>  1.Wrapped crypto assets are tokens backed one-to-one by an underlying asset and aim to enable interoperability between different blockchains. Wrapped BTC, issued by BitGo, was the first ERC20 token backed 1:1 with Bitcoin.<br>  2.Staking is the act of locking crypto assets for a period of time to support the operation of a blockchain in exchange, with the goal of earning more cryptoassets. Lido offers staking solutions.<br>  3. Restaking allows staked assets to be reused for additional rewards, enhancing utility, and liquidity. Protocols like Eigenlayer offer restaking.This asset class has a separate rank because they are rehypothecated.<br> <a href="#" class="link"><strong>더 읽기</strong></a>
							</div>
						</div>
					</div>
					<div class="card-info-box">
						<div class="card-info">
							<div class="card-info-flex">
								<div class="inter _12s normal _61co">시가 총액</div>
						...
						<div class="card-info">
							<div class="card-info-flex">
								<div class="inter _12s normal _61co">거래량</div>
								<div class="inter _16s semibold">
									<strong>₩183,703,400,327,467</strong>
								</div>
								<div class="w-layout-vflex rate-flex-box">
